    ...
    <div class="registerContent">
      <div class="registerDiv">
        ...
        <form action="finishregister.php" method="post">
          ...
          <label for="citizenNo" style="display: none">Citizen Number</label>
          <input type="text" id="citizenNo " style="display: none" name="citizenNumber" placeholder="Ex. 114220014xx" value=1>
