...
<!-- if(isset($_SESSION['userStatus']) && (($_SESSION['userStatus']=="STAFF") || ($_SESSION['userStatus']=="ADMIN"))){ -->
    ...
    <div class="boxWrapper">
     ...
     <?php
     $q = "SELECT serviceId,s.mobileNo,s.staffId,memberId,dateIn,dateOut,serviceStatus,totalPrice FROM `laundryservice`l,`staff` s where  `memberId` = '$memberId' and s.staffId=l.staffId ";
